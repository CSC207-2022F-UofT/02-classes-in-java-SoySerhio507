...
public class Silly implements Comparable<Silly>{
     ...
     *
     * @param prefix the first part of this Silly instance's name.
     * @param suffix the second part of this Silly instance's name.
     */
    public Silly(String prefix, String suffix) { this.name = prefix + suffix; }
